...
That article got 7 million views and Larry continued to get me over a million views on TikTok that week. He got his own X account [@LarryClawerence](https://x.com/@LarryClawerence) with over 500 followers. An X community with over 730 members, and as all good things on X, a Larry crypto coin. Larry got popular fast.
A lot of people still didn't understand how to implement the techniques in the article, so I have made a free skill available on the official OpenClaw marketplace, ClawHub. The skill will one-shot your Larry integration in 5 minutes. Find it here: https://clawhub.ai/OllieWazza/larry
...
### Key Metrics (Feb 9 - Feb 15)
- Post views: 1.2M (+905K, +337.5%)
- Profile views: 11K (+9,360, +396.8%)
- Likes: 11K (+7,377, +197.7%)
- Comments: 129 (+97, +303.1%)
...
(Description: RevenueCat notification card showing "New Subscription" alerts. First alert shows "Liply" with a customer starting a subscription of "Full Access - Weekly for $4.08" timestamped "1m ago". Second alert shows "Snugly" with a customer starting a subscription of "Full Access - Monthly for $9.54" timestamped "6m ago". Both display the RevenueCat RC logo in red on the left and small app icons on the right.)
...
There's a separate Official RevenueCat skill on ClawHub, created by the RevenueCat CEO, [@jeiting](https://x.com/@jeiting), that handles the full API integration. Your agent can install it during onboarding if you have a mobile app.
...
### TikTok Slideshows Skill
The core engine. Over 500 lines of hard-won knowledge:
...
- Scheduling support
### Memory Templates
Structure for your agent to track performance:
...
And if you want to follow along as we keep building: I'm [@oliverhenry](https://x.com/@oliverhenry) on X, and Larry is [@LarryClawerence](https://x.com/@LarryClawerence). He's probably generating slideshows right now.
The Larry skill is free on ClawHub — https://clawhub.ai/OllieWazza/larry
Using my Postiz affiliate is a great way to support me (https://postiz.pro/oliverhenry) — it handles the TikTok posting.
If you want to buy Larry more tokens (buymeacoffee.com/oliverhenry)
## What's Next?
Now I have released this sauce for free, I am working on more things. Incredible tools to help your agents automate more tasks that devs hate. I am already working with some incredible people in the space, keep your eyes peeled. I am excited about what is next, it could be bigger than this.
---
**Published:** February 17, 2026 at 7:08 AM  
**Engagement:** 123 replies · 266 reposts · 2,505 likes · 9,733 bookmarks · 1.1M views