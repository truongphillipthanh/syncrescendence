...
**Proven at scale**: The Claude Code research corpus (160+ files, 223K words) was metabolized into praxis (22 docs, 22.7K words) using this methodology, achieving 85%+ compression.
...
**Process**:
1. Compare tool's terminology against `engine/REF-ROSETTA_STONE.md`
...
**Process**:
1. Update platform avatar files (e.g., engine/AVATAR-CODEX.md, AVATAR-GEMINI-WEB.md, AVATAR-GEMINI-CLI.md, or create new)
2. Create/update skills if new capabilities warrant automation
3. Test integration with existing workflows
4. Document learnings in praxis
...
| Synthesis documents | `praxis/synthesis/` | `SYNTHESIS-[tool]_[domain].md` |
| Mechanics documents | `praxis/mechanics/` | `MECH-[mechanism].md` |
| Practice documents | `praxis/practice/` | `PRAC-[pattern].md` |
| Platform avatar | `engine/` | `AVATAR-[TOOL].md` |
| ROSETTA-STONE updates | `engine/` | Append to `REF-ROSETTA_STONE.md` |
