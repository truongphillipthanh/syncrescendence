...
Choice: Place the cognitive nucleus in orchestration root (flat principle compliance).
...
Touched surfaces: orchestration/*
Evidence pointers: CLAUDE.md, orchestration/state/REF-STANDARDS.md
```
