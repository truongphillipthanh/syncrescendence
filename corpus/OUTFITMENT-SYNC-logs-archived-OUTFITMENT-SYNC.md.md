...
- `orchestration/openclaw/openclaw.template.json` (no secrets)
- optional `orchestration/openclaw/openclaw.<persona>.json` overlays:
...
Implemented:
- `orchestration/scripts/sync_openclaw_skills.sh`
