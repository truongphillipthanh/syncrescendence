...
| Sigma Knowledge | `praxis/` | New mechanics/ or practice/ docs |
| Canon | `canon/` | If insight reaches canonical certainty |

### Step 10: ARCHIVE

**Actor**: Commander or automation script
**Action**:
1. Move processed .md files from `~/Desktop/research/` to `sources/research/batch-YYYY-MM-DD/`
...
Actions:
  1. Run shell script: /Users/system/syncrescendence/orchestration/scripts/classify_research.sh "$1"
...
<dict>
    ...
    <array>
        <string>/Users/system/syncrescendence/orchestration/scripts/research_threshold.sh</string>
    </array>
...
- **IMPL-P-0009** -- Build `archive_research.sh`: Move processed files to `sources/research/batch-YYYY-MM-DD/`, update manifest, commit (Priority: P1)
...
- `/Users/system/syncrescendence/orchestration/state/impl/clarescence/RESEARCH-CORPUS-SOVEREIGN-CURATION-PATTERN.md`
- `/Users/system/syncrescendence/orchestration/state/impl/clarescence/RESEARCH-CORPUS-REPO-EXTRACTION.md`
- `/Users/system/syncrescendence/COCKPIT.md`
- `/Users/system/syncrescendence/orchestration/state/IMPLEMENTATION-BACKLOG.md`
