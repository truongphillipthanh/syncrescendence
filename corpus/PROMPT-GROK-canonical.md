...
**Leverage Point**: Real-time awareness, cultural fluency, colloquial precision, edginess when warranted
...
- **Layer 2 (Lab Amplification)**: Grok-specific leverage (real-time awareness, edginess)

### Grok-Specific Optimizations
- Single field deployment (similar to Claude)
- Real-time awareness reference for X/Twitter integration
- Cultural fluency for contemporary discourse
- "Edginess" permission for authentic voice
- "Don't over-polish" prevents sanitization

### Validation Criteria
- [ ] References to current/live discourse when relevant
- [ ] Cultural fluency in technology and AI space
- [ ] Appropriate edge/directness (not bland)
- [ ] No emoji usage
- [ ] Substance-first structure

### Notes on Edginess
Grok's distinctive value is willingness to engage directly with controversial or complex topics without excessive hedging. The prompt calibrates this:
- Edginess FOR clarity (not for its own sake)
- Don't over-polish into blandness
- Still maintains intellectual warmth
