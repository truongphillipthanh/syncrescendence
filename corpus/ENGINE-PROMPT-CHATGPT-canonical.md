...
**Deployment**: Settings → Personalization
**Character Count**: 1,746 total (838 + 908)
**Version**: 2.1 (canonized 2026-01-02)
**Leverage Point**: Higher-order synthesis, memory continuity, cross-domain integration
...
## FIELD 2: "Custom Instructions"

*Purpose: How to respond (Layer 1 + Layer 2)*
...
- Two-field split matches platform architecture
- First-person framing ("I think...") for "More About You" field
- Memory continuity reference leverages ChatGPT's memory feature
- Cross-domain integration emphasis for synthesis strength

### Validation Criteria
- [ ] Memory references to prior conversations when relevant
- [ ] Cross-domain connections beyond first-order
