  ...
  tell application "iTerm"
    ...
    tell w1
      ...
      tell current session
        write text "cd \"" & repoPath & "\" && git pull && bash orchestration/scripts/psyche_boot.sh && bash orchestration/scripts/tmux_dashboard.sh"
      end tell
    end tell
    ...
    tell w2
      ...
      tell current session
        write text "cd \"" & repoPath & "\" && git pull && bash orchestration/scripts/commander_special_forces.sh"
      end tell
    end tell
