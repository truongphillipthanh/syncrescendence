...
- Templates: orchestration/templates/CANON-{id}.md.j2
- Data mapping: orchestration/templates/template_registry.json
- Output: canon/CANON-{id}-*.md (discovered by prefix match)
...
CANON_DIR = ORCHESTRATION_ROOT.parent / "canon"
...
def find_output_file(canon_id, registry_entry):
    ...
    # Discover by prefix match in canon/
