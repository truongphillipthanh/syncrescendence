...
bash orchestration/scripts/dispatch.sh adjudicator \
...
bash orchestration/scripts/dispatch.sh cartographer \
  "CANON_COHERENCE_SCAN" \
  "Read all 79 CANON files in canon/. For each: verify frontmatter integrity, check cross-references resolve, flag orphaned wikilinks. Report coherence score." \
...
bash orchestration/scripts/dispatch.sh ajna \
  "SMOKE_TEST" \
