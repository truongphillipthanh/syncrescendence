...
The most important realization following this idea is this:
...
(Description: Comparison diagram with two columns. Left column labeled "CALLED A SCAM" shows the Humane AI Pin with bullet points listing multiple required behavior changes. Right column labeled "NEAR ZERO ADOPTION" shows Google Glass with similar behavior requirements listed.)
...
(Description: Evolution diagram titled "WISPR EVOLUTION" showing three stages: Stage 0 (hardware wearable), Stage 0.5 (software - wispr flow with "behavior required" label), and Result (90% word of mouth with "organic growth" indicator). The progression illustrates the pivot from hardware to software and the resulting organic adoption.)
## II - Product
...
### 1. Structure by having 2-person pods.
...
### 2. Hire ex-founders, not ex-employees
...
### 3. Hire for taste, not just skill
...
Happy building :)
---
**Published:** 2:02 PM · Feb 12, 2026  
**Engagement:** 50 replies, 169 reposts, 1,735 likes, 4,648 bookmarks, 536,272 views