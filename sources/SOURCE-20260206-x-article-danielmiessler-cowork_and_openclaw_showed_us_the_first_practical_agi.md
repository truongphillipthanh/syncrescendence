...
The average day for an average knowledge worker involves dozens or thousands of these tiny, highly-varied micro-adjustments to even enable them to do their regular job—whatever that is.
...
Turned out the reservation system online was broken, so his agent taught itself how to speak using Eleven Labs and just called the restaurant itself and booked it. 🤯
