...
(Description: A dialog box displaying word count statistics from a transcription. The box shows "Pages: 206", "Words: 58357", "Characters: 313191", "Characters excluding spaces: 262655" with a checkbox option for "Display word count while typing" and Cancel/OK buttons.)
...
(Description: A file system visualization showing four folders labeled "extracted", "output", "scripts" arranged with light blue folder icons, alongside a white document icon labeled "CLAUDE.md" against a dark gray background.)
...
Now create the CLAUDE.md file. This is the most important part of the entire system.

CLAUDE.md is a text file that Claude Code reads automatically every time you open a session in that folder. Think of it as the brief you'd give a brilliant new hire on their first day. It tells Claude who you are, what you need, and exactly how you want the work done.

Here's the exact CLAUDE.md I use for my folders. Copy this and change the details to fit your business:
...
Create a CLAUDE.md for each thinker. Same structure, just swap the name and adjust the context based on what that thinker specializes in.
...
Paste your CLAUDE.md into the Project Instructions section. Upload all your transcripts into Project Knowledge. That's your setup done.
