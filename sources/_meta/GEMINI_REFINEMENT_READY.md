...
## Script Location
`/Users/system/syncrescendence/orchestration/scripts/gemini_refine.py`

## How to Run
```bash
source ~/.syncrescendence/venv/bin/activate && python3 /Users/system/syncrescendence/orchestration/scripts/gemini_refine.py
```
...
- `--resume` — skip files already refined (tracked in `sources/_meta/.gemini_refined.txt`)
