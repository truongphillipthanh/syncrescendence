...
```
// BAD (not verified)
"See file 02-OPERATIONAL/nonexistent.md"

// GOOD (verified)
"`ls 02-OPERATIONAL/` shows no file matching that name. Did you mean IIC-Acumen-config.md?"
```
...
```json
{
  "findings": [
    ...
    "02-OPERATIONAL/IIC-Coherence-config.md:line-89 - 'Opus recommended for framework development'"
  ],
  "uncertainties": [
