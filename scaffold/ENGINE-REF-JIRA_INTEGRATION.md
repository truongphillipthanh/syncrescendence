...
4. **Retrospective** (Jira -> Repo): Retrospective notes flow to `praxis/practice/` or EXEMPLA docs.
...
| Sprint Retrospective | End of sprint | Jira retrospective board | `praxis/practice/` entry |
