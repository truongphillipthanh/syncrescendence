...
5. Archive raw logs: git history preserves; cognitive core stays lean
...
canon/         — What (constitutional, defended)
engine/        — Functions, prompts, avatars, queue items
sources/       — Curated references (preservation-worthy)
praxis/         — Operational knowledge + memory + exempla <- THIS
```
