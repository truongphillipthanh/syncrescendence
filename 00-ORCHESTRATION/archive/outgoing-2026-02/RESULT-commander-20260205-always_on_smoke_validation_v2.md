...
3. **Re-arm watchers**: Run `bash 00-ORCHESTRATION/scripts/rearm_watchers.sh --mini` to sync installed plists from repo (after repo plists are updated with HOME env var)
