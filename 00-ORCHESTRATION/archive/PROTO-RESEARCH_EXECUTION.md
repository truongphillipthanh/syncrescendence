...
**Output**: Source inventory file at `04-SOURCES/research/{tool}/SOURCE_INVENTORY.md`
...
**Process**:
1. Archive sources to `04-SOURCES/research/{tool}/`
...
**Output**: `04-SOURCES/research/{tool}/SYNTHESIS-{tool}.md`
...
**Process**:
1. Update/create avatar config (`02-ENGINE/AVATAR-{TOOL}.md`)
...
|---|---|---|
| Source inventory | `04-SOURCES/research/{tool}/` | `SOURCE_INVENTORY.md` |
| Raw sources | `04-SOURCES/research/{tool}/` | `{platform}-{tool}.md` |
| Synthesis | `04-SOURCES/research/{tool}/` | `SYNTHESIS-{tool}.md` |
| Rosetta delta | `02-ENGINE/` | Append to `REF-ROSETTA_STONE.md` |
| Avatar config | `02-ENGINE/` | `AVATAR-{TOOL}.md` |
