...
The SN encoding at `01-CANON/sn/CANON-31150-PLATFORM_CAPABILITY_CATALOG.md` has 4 matching references.

## Proposed Action

1. Run `python3 00-ORCHESTRATION/scripts/regenerate_canon.py` (already updated with correct terminology)
