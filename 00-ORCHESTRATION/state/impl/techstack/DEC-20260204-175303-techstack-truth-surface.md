...
Choice: Unify “model_db” and “Tech Stack DB” by declaring a single canonical boundary: **model intelligence (models/pricing/capabilities/routing)** remains in `00-ORCHESTRATION/state/model_intelligence.db` (managed by `model_db.py`), while **apps/workflows/primitives/apparatus** becomes the future “Tech Stack DB” slice. The Tech Stack DB must *not* create a second overlapping models/pricing store; it must import from, or federate to, model_intelligence.
...
Touched surfaces: 00-ORCHESTRATION/scripts/model_db.py; CANON-30300-TECH_STACK-*; future `00-ORCHESTRATION/state/techstack/*`; Makefile targets (techstack-import/seed)
Evidence pointers: 01-CANON/CANON-30300-TECH_STACK-comet-INTELLIGENCE.md; 00-ORCHESTRATION/scripts/model_db.py (header: “pilot implementation of CANON-30300 subset”); 00-ORCHESTRATION/state/impl/tooling/INTERDEPENDENCIES-CONFLICTS.md
