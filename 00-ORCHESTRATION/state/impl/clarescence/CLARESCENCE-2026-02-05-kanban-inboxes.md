...
### Surfaces
- Dispatch files are created by `00-ORCHESTRATION/scripts/dispatch.sh` into `-INBOX/<agent>/TASK-*.md`
- Watchers (`watch_dispatch.sh`) watch `-INBOX/<agent>/` and:
  ...
  - append lifecycle events to `00-ORCHESTRATION/state/DYN-GLOBAL_LEDGER.md`
