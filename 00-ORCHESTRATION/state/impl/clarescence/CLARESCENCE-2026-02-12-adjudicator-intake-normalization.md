...
Test: create a metadata-less test task in `-INBOX/adjudicator/00-INBOX0/`, run `bash 00-ORCHESTRATION/scripts/triage_inbox.sh adjudicator`, and verify whether it is surfaced as actionable without manual interpretation.
...
- Oriented to: `COCKPIT.md`, `00-ORCHESTRATION/state/ARCH-INTENTION_COMPASS.md`, `git status`, `git log -5`, commander inbox, sovereign queue.
- Verified state:
...
- Prior clarescence: multiple dispatch/task-flow analyses in `00-ORCHESTRATION/state/impl/clarescence/`, including adjudicator routing and watcher behavior.
...
- Terms validated in `02-ENGINE/REF-ROSETTA_STONE.md`: Constitutional, Sovereignty, Ground Truth, clarescence patterns.
