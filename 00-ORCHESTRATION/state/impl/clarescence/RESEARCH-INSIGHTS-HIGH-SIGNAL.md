...
**Syncrescendence action:** Migrate our per-domain instructions into `.claude/rules/` with path scoping. E.g., `rules/orchestration.md` scoped to `00-ORCHESTRATION/**`, `rules/convergence.md` scoped to convergence paths.
