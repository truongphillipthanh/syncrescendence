...
|-------|-----------|---------|--------|
| **L1: Compression** | `sn_encode.py`, `sn_decode.py`, `01-CANON/sn/` (81 mirror files) | Token reduction (~68-80%) via symbol substitution | **DORMANT** |
...
| Signal | Finding |
|--------|---------|
| `sn_expand.py --check 01-CANON/sn/` | **0 refs expanded** — no active `${...}` variable references in SN files |
