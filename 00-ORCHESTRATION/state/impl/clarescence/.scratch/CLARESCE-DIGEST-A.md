...
- **3-Tier Sovereign Escalation**: PROCEED (agent autonomous: file ops, formatting) | NOTIFY (proceed + write to `-SOVEREIGN/`: arch decisions, dependency changes) | BLOCK (must wait: 01-CANON/, credentials, git push). (sovereign-cockpit-architecture)
