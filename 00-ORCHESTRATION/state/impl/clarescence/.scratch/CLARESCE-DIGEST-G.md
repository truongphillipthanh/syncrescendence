...
- **DA-RESEARCH-PARTITION-001**: 267-file research corpus partitioned into 14 NotebookLM-ready directories at `04-SOURCES/research-notebooks/`. Curation pattern formalized (military intelligence cycle: scan→detect→saturate→synthesize). 42 GitHub repos, 8 MCP servers cataloged for whitelabeling.
