...
|-----------|-----------|-----------------|---------|
| 00-ORCHESTRATION/ | ~85 | ~35K | Strategic coordination (state/, scripts/, archive/) |
| 01-CANON/ | ~160 | ~87K | Verified canonical knowledge (79 CANON docs + sn/) |
| 02-ENGINE/ | ~75 | ~18K | Functions, prompts, avatars, model profiles |
| 04-SOURCES/ | ~150 | ~42K | Source documents (raw/, processed/, research/) |
| 05-SIGMA/ | ~18 | ~4K | Operational knowledge corpus |
