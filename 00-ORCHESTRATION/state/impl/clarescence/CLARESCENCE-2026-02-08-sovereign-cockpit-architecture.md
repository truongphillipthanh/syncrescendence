...
related:
  ...
  - 02-ENGINE/REF-STACK_TELEOLOGY.md
  - 00-ORCHESTRATION/state/REF-NEO_BLITZKRIEG_BUILDOUT.md
  - COCKPIT.md
...
3. **BLOCK** — agent must wait for Sovereign: any operation touching `01-CANON/`, account credentials, external API calls, git push
