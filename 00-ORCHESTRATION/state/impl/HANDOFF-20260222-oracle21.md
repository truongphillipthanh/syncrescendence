...
| Item | Blocker | Retry |
|------|---------|-------|
| Transcript backfill (1,157 files) | YouTube IP ban | `source ~/.syncrescendence/venv/bin/activate && python3 00-ORCHESTRATION/scripts/batch_transcribe.py --max 50` |
| Gemini refinement (835+ files) | API 429 quota | `python3 00-ORCHESTRATION/scripts/gemini_refine.py --resume --max 10` |
