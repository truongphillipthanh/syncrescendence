...
Write staleness report to `00-ORCHESTRATION/state/DYN-CORPUS_STALENESS_REPORT.md`:
...
1. Write report to `00-ORCHESTRATION/state/DYN-CORPUS_STALENESS_REPORT.md`
