...
- Re-armed `com.syncrescendence.watch-adjudicator` plist from `00-ORCHESTRATION/scripts/launchd-mini/`.
...
- Updated `02-ENGINE/MODEL-INDEX.md` with Feb 2026 model data (Opus 4.6, GPT-5.3-codex, Gemini 3.0 GA imminent).
- Updated `02-ENGINE/DYN-PLATFORMS.csv` with current context windows and OpenClaw roles.
- Refreshed `02-ENGINE/SURVEY-AI_ECOSYSTEM_SURVEY.md` — 2026 shift toward agentic platforms and always-on sensing.
- Created `00-ORCHESTRATION/scripts/sensing-model-refresh.sh` for future automation.
