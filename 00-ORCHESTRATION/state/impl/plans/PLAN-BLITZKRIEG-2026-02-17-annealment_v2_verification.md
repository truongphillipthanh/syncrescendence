...
All output files at: `00-ORCHESTRATION/state/impl/.scratch/`
...
1. 00-ORCHESTRATION/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md
2. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-CANON-0X.md
3. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-CANON-1X2X.md

OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-A-canon_0x_1x2x.md):
...
READ THESE FILES IN ORDER:
1. 00-ORCHESTRATION/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md
2. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-CANON-30.md
3. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-CANON-31.md
4. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-CANON-32-35.md

OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-B-canon_30_31_32.md):
...
READ THESE FILES IN ORDER:
1. 00-ORCHESTRATION/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md
2. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-GAPS.md
3. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-METACHAR.md
4. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-SCAFFOLD.md

OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-C-gaps_metachar_scaffold.md):
...
READ THESE FILES IN ORDER:
1. 00-ORCHESTRATION/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md
2. 00-ORCHESTRATION/state/impl/clarescence/.scratch/ANNEAL-DIGEST-CLARESCENCE.md

OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-D-clarescence.md):
...
READ THESE FILES IN ORDER:
1. 00-ORCHESTRATION/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md
2. 00-ORCHESTRATION/state/impl/.scratch/ANNEAL-DIGEST-METACHAR.md
...
OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-E-metachar_raw_1.md):
...
OUTPUT FORMAT (write to 00-ORCHESTRATION/state/impl/.scratch/VERIFY-F-metachar_raw_2.md):
...
**`00-ORCHESTRATION/state/impl/.scratch/ANNEAL-V2-PATCHES.md`**
