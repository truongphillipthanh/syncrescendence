...
**Core Scripts**:
- `00-ORCHESTRATION/scripts/dispatch.sh` — Task creation and dispatch
- `00-ORCHESTRATION/scripts/watch_dispatch.sh` — Autonomous task processing (fswatch + polling)
- `00-ORCHESTRATION/scripts/append_ledger.sh` — Event logging
...
- `00-ORCHESTRATION/scripts/append_ledger.sh` — Event logger
