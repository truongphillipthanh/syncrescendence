...
**Lineage**: Successor to deleted `00-ORCHESTRATION/TERMINAL-STACK-CONFIG.md` (commit `8b8f965`). Companion to `02-ENGINE/REF-SOVEREIGN_COCKPIT_MANIFEST.md` (verbatim config dump) and `00-ORCHESTRATION/DEPLOYMENT-PLAYBOOK.md` (full deployment reference).
...
Script: 00-ORCHESTRATION/scripts/cockpit.sh
```
...
alias cockpit='bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh'
alias cockpit-launch='bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh --launch'
alias cockpit-resize='bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh --resize'
alias cockpit-kill='bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh --kill'
```
...
| Document | Path | Scope |
|----------|------|-------|
| Sovereign Cockpit Manifest | `02-ENGINE/REF-SOVEREIGN_COCKPIT_MANIFEST.md` | Verbatim config dump (~2600 lines) |
| Deployment Playbook | `00-ORCHESTRATION/DEPLOYMENT-PLAYBOOK.md` | Full tool inventory + install procedures |
| Stack Teleology | `02-ENGINE/REF-STACK_TELEOLOGY.md` | Tool disposition analysis (active/sunset/evaluating) |
| Cockpit Protocol | `00-ORCHESTRATION/state/ARCH-COCKPIT_OPERATIONAL_PROTOCOL.md` | Operational protocol for cockpit sessions |
| Cockpit Overview | `COCKPIT.md` | 30,000ft system overview with cockpit layout |
| Lifestyle Clarescence | `00-ORCHESTRATION/state/impl/clarescence/CLARESCENCE-2026-02-08-cockpit-lifestyle-layer.md` | Decision atoms for lifestyle tools |
| HQ Elucidation | `00-ORCHESTRATION/state/impl/clarescence/CLARESCENCE-2026-02-08-headquarters-elucidation.md` | Full HQ audit with drift resolution |
| MBA Ajna Setup | `00-ORCHESTRATION/state/impl/clarescence/CLARESCENCE-2026-02-09-mba-ajna-setup.md` | MBA deployment guide |
| Implementation Map | `00-ORCHESTRATION/state/IMPLEMENTATION-MAP.md` | Tranche E (IMPL-E-0001 through IMPL-E-0009) |
| Deferred Commitments | `00-ORCHESTRATION/state/DYN-DEFERRED_COMMITMENTS.md` | DC-009 (this file's creation) |
