...
OpenClaw configs live outside the repo at system level. The repo holds a mirror document (`02-ENGINE/REF-OPENCLAW_CONFIG_MIRROR.md`) that captures canonical configuration. Protocol:
