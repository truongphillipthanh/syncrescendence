...
Layer 2: CURRENT STATE (living reference)
  02-ENGINE/MODEL-INDEX.md (existing, restructured)
...
Layer 3: CANON INTEGRATION (stable knowledge)
  01-CANON/CANON-30300-TECH_STACK-comet.md (existing)
...
Script: 00-ORCHESTRATION/scripts/ticker_sense.sh
...
- Create `02-ENGINE/DYN-TICKER_FEED.md` with initial entries
...
- `02-ENGINE/MODEL-INDEX.md` — Current model registry (to be restructured)
- `01-CANON/CANON-30300-TECH_STACK-comet.md` — Canonical tech stack (SQL schemas)
- `02-ENGINE/REF-STACK_TELEOLOGY.md` — Stack teleology (FIDS aspiration, line 335)
- `05-SIGMA/MEMORY-AJNA-THREAD-EXTRACTION.md` — FIDS concept origin (line 111)
- `01-CANON/CANON-25200-CONSTELLATION_ARCH-lattice.md` — Constellation architecture
- `00-ORCHESTRATION/state/REF-DESKTOP_CAPTURE_INVENTORY.md` — Original ticker directive (line 229)
