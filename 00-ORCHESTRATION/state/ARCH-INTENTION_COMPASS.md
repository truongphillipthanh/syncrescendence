...
| INT-1210 | 12 | "Canonize Model Manual/Prompting conceptual space" | active | Verify coverage in CANON-31100-ACUMEN, CANON-31120-TONE_LIBRARY, translate.xml |
| INT-1211 | 12 | "Canonize Platform Features/Ecosystem Leverage" | active | Cross-ref CANON-31142-PLATFORM_GRAMMAR, AI_ECOSYSTEM_SURVEY.md |
| INT-1212 | 12 | "Canonize Model Qualities/Capabilities/Benchmarks" | active | Cross-ref MODEL_INDEX.md, CANON-30000-INTELLIGENCE |
| INT-1213 | 12 | "Blitzkrieg model specification protocol" | active | Formalize in CLAUDE.md or coordination.yaml |
