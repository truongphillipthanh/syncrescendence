...
- `02-ENGINE/ontology/` (implementation-facing)
- OR `00-ORCHESTRATION/state/REF-ONTOLOGY_REGISTRY.md` (protocol + schema)
- With data in: `02-ENGINE/ontology/registry/` (YAML/JSON)

Recommendation:
- **Schema + conventions** in `00-ORCHESTRATION/state/REF-ONTOLOGY_REGISTRY.md`
- **Entities** in `02-ENGINE/ontology/registry/` (data-first)
