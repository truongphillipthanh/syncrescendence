...
# No set -e or pipefail — monitoring scripts must degrade gracefully.
# ls/find returning no matches must not abort the cycle.
set -u
...
# Agent roles: adjudicator=CQO, cartographer=CIO, psyche=CTO, commander=COO, ajna=CSO
