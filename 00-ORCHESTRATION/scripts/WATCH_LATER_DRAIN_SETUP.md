...
python 00-ORCHESTRATION/scripts/drain_watch_later.py --dry-run

# Full drain
python 00-ORCHESTRATION/scripts/drain_watch_later.py

# Use Firefox instead of Chrome
python 00-ORCHESTRATION/scripts/drain_watch_later.py --cookies-from-browser firefox

# Use exported cookies file
python 00-ORCHESTRATION/scripts/drain_watch_later.py --cookies-file ~/wl_cookies.txt

# Verbose logging
python 00-ORCHESTRATION/scripts/drain_watch_later.py -v
```
...
| `--sources-dir` | `04-SOURCES/` | Override output directory |
...
- SOURCE files: `04-SOURCES/SOURCE-{YYYYMMDD}-youtube-{format}-{creator}-{title}.md`
- Dedup index: `04-SOURCES/_meta/URL_INDEX.txt` (one URL per line, appended)
