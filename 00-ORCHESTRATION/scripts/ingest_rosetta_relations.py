...
DEFAULT_DB_PATH = os.environ.get(
    "ONTOLOGY_DB",
    os.path.expanduser("~/Desktop/syncrescendence/00-ORCHESTRATION/state/ontology.db"),
)
DEFAULT_BRIDGE_PATH = os.path.expanduser(
    "~/Desktop/syncrescendence/00-ORCHESTRATION/state/ARCH-ROSETTA_ONTOLOGY_BRIDGE.md"
)
