...
| Existing cockpit scripts | Present | `00-ORCHESTRATION/scripts/tmux_mba_cockpit.sh`, `tmux_dashboard.sh` |
...
File: `00-ORCHESTRATION/scripts/cockpit.sh`
...
startup_command = "bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh"
...
sesh connect constellation -c "bash ~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh --launch"
...
- [ ] Write `cockpit.sh` to `00-ORCHESTRATION/scripts/cockpit.sh` (Section 3)
