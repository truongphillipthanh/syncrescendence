...
PEDIGREE_FILE="$REPO_ROOT/00-ORCHESTRATION/state/DYN-PEDIGREE_LOG.md"
INTENTIONS_QUEUE="$REPO_ROOT/00-ORCHESTRATION/state/DYN-INTENTIONS_QUEUE.md"
...
CANON_FILES_TOUCHED=$(echo "$FILES_MODIFIED" | grep "01-CANON/" || echo "none")
ENGINE_FILES_TOUCHED=$(echo "$FILES_MODIFIED" | grep "02-ENGINE/" || echo "none")
