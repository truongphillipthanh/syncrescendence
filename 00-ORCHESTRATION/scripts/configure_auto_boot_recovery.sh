...
TPL_DIR="$REPO/00-ORCHESTRATION/scripts/launchd-mini"
UID_NUM="$(id -u)"
...
chmod +x \
  "$REPO/00-ORCHESTRATION/scripts/ensure_docker_desktop.sh" \
  "$REPO/00-ORCHESTRATION/scripts/launch_cockpit_when_docker_ready.sh" \
  "$REPO/00-ORCHESTRATION/scripts/auto_ingest_supervisor.sh" \
  "$REPO/00-ORCHESTRATION/scripts/auto_ingest_all.sh" \
  "$REPO/00-ORCHESTRATION/scripts/auto_ingest_loop.sh"
