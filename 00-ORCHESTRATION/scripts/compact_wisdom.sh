...
DIR_STAGING="$REPO_ROOT/00-ORCHESTRATION/state/DYN-DIRECTIVE_STAGING.md"
EXEC_STAGING="$REPO_ROOT/00-ORCHESTRATION/state/DYN-EXECUTION_STAGING.md"
DIR_COMPENDIUM="$REPO_ROOT/00-ORCHESTRATION/archive/ARCH-DIRECTIVE_COMPENDIUM.md"
EXEC_HISTORY="$REPO_ROOT/00-ORCHESTRATION/archive/ARCH-EXECUTION_HISTORY.md"
