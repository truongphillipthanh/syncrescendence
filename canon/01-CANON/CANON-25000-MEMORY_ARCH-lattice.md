...
**Why this matters for large repositories**: The Syncrescendence corpus contains 784 files across semantically distinct directories. Rules for canon/ (protected, do not modify) differ from rules for sources/ (working material, freely editable). Conditional rules express these distinctions without requiring Claude Code to hold all context simultaneously.
