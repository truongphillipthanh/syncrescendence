...
sn_version: 2.0.0
compression: ~85%
regeneration_source: orchestration/state/platform_capabilities.json
```
...
steps:
  1: edit_data_source >> vim orchestration/state/platform_capabilities.json
  2: regenerate >> python3 orchestration/scripts/regenerate_canon.py 31150
  3: review_diff >> git diff canon/CANON-31150*.md
