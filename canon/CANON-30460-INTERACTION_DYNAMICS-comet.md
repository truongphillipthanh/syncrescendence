...
entities_defined:
  ...
  - "Oscillating Refinement Pattern (PROTO)"
  - "Triangulated Synthesis Pattern (PROTO)"
  - "Sensing Loop Pattern (PROTO)"
  - "Tiered Specification (CON)"
  - "Platform Limitation Matrix (STR)"
...
MANIFEST=$(cat orchestration/corpus_manifest.md)
