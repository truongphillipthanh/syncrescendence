...
|------|-------------|-------------------|
| A (Commander) | `00-ORCHESTRATION/`, `CLAUDE.md`, ledgers | `01-CANON/` (read) |
| B (Adjudicator) | `02-ENGINE/` (quality), test scripts | `01-CANON/` (read) |
| C (Cartographer) | `04-SOURCES/research/`, `05-SIGMA/` | `01-CANON/` (read) |
| D (Psyche) | `02-ENGINE/` (automation), `.openclaw/` | `01-CANON/` (read) |

**Rule**: `01-CANON/` is write-protected during Blitzkrieg. Only the Commander (or Sovereign) merges CANON changes post-Blitzkrieg.
...
```bash
# From repo root
bash 00-ORCHESTRATION/scripts/setup-worktrees.sh
```
...
- `00-ORCHESTRATION/scripts/setup-worktrees.sh` — Setup script (70 lines)
- `04-SOURCES/research/MECH-git_worktree_coordination.md` — Deep mechanics (zone ownership, coordination.yaml schema)
- `04-SOURCES/research/PRAC-parallel_claude_orchestration.md` — Multi-instance patterns
- `02-ENGINE/REF-ROSETTA_STONE.md` — Gap Analysis G5
