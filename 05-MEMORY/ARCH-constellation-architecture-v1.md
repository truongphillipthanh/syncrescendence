...
│   02-ENGINE/ ← Active configurations                      │
└─────────────────────────────────────────────────────────────────┘
                              │
...
### What to Archive (move to 05-MEMORY/)
...
- 02-ENGINE/prompts/ (active configurations)
- 04-SOURCES/ (working material)

### What to Create

- 02-ENGINE/constellation/ (new home for platform configs)
  - claude-web.md
  - chatgpt-compiler.md
  - gemini-digestor.md
  - gemini-cli.md
...
3. **Archive historical artifacts**
   - Move directive history to 05-MEMORY/
   - Keep state minimal
