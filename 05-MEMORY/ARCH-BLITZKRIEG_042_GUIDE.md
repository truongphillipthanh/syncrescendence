...
2. Copy to repository:
   ...
   # Corrected prompts
   cp *-unified-prompt.md 02-ENGINE/prompts/unified/
...
- [ ] IIC config files exist in 02-ENGINE/iic/
- [ ] Corrected prompts in 02-ENGINE/prompts/unified/
...
head -20 02-ENGINE/prompts/unified/Claude-unified-prompt.md
# Should show <system_prompt> tags

# IIC configs should be comprehensive
wc -l 02-ENGINE/iic/IIC-Acumen-config.md
# Should be 100+ lines
```
