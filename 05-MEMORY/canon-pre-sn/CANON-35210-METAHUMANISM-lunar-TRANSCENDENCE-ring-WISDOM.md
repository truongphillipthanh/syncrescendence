...
# [[CANON-35210-METAHUMANISM-lunar-TRANSCENDENCE-ring-WISDOM]]: METAHUMANISM FRAMEWORK
...
LEVEL 4: Meta-Volition (willing about willing)
    ↑
LEVEL 3: Second-Order Volition (wanting to want)
    ↑
LEVEL 2: Deliberative Will (conscious choosing)
    ↑
...
- **Content Production**: Deep substrate for IIC strategy
