...
**Limitation**: Sovereign must manage parallel queries manually.
...
2. Sovereign downloads artifact (or copies from Claude artifact viewer)
3. Sovereign pastes into ChatGPT Project conversation
...
6. Sovereign downloads Canvas content
...
5. Sovereign pastes evidence pack into Claude Web for interpretation
...
- The repository is ground truth; your artifacts feed into that repository via the Sovereign
...
# Sovereign pastes into next platform
```
...
decision:
  ...
  verification:
    ...
    failure_indicators:
      ...
      - Sovereign cognitive load increases
...
### Phase 2: Sovereign Configuration (Manual)
