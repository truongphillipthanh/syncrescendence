...
Ψ-SPEC/            — Operational specifications (was 02-ENGINE, cleaned)
Ψ-FLOW/            — Active work (was 03-QUEUE, renamed for clarity)
Ψ-MEMORY/          — Short-term memory, semantic archive (was 05-MEMORY)
...
Actions:
  1. Open terminal
  2. Run: gemini -p "$(cat 02-ENGINE/prompts/GEMINI-SENSING.md)"
