...
|------|------|-------------|
| `claude_code_optimization_architecture.md` | 32K | → `05-MEMORY/RESEARCH-*` or distill |
...
**Solution**: Create `05-MEMORY/RESEARCH-*` pattern:
- Prefix: `RESEARCH-{YYYYMMDD}-{topic}.md`
- Location: `05-MEMORY/` (historical preservation)
...
ls 05-MEMORY/RESEARCH-* | wc -l  # Should be 1+
