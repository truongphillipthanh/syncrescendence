...
**To understand operations**: See CANON-00010-OPERATIONS
**To understand the chains**: See CANON-21000-CHAIN_MATRIX
...
- NAME = Human-readable descriptor (uppercase with underscores)
- tier = cosmos|core|lattice|chain|planetary|lunar|satellite

## File Count

Total CANON documents: 82
