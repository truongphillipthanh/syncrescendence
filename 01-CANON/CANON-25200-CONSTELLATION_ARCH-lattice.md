...
TERM ConstitutionalBasis:
    sutra: "From Oracle 12 (Sovereign's words): > "Claude Code wielded by Claude Opus 4.5 represents a seismi..."
    gloss:
...
3. Sovereign activates Claude Code with directive path
