...
TERM PlatformSpecializations:
    ...
    spec:
        ...
        Claude_Account_2_Alpha:
            ...
            zone_ownership: 04-SOURCES/processed/a-* | logs/*-A.md | Stream_A
        Claude_Account_3_Beta:
            ...
            zone_ownership: 04-SOURCES/processed/b-* | logs/*-B.md | Stream_B
        Gemini_Advanced:
...
ARTIFACT SustainabilityRoadmap:
    ...
    spec:
        ...
        security:
            ...
            protected_zones: 01-CANON | oracle_contexts | CLAUDE.md | coordination.yaml
end
