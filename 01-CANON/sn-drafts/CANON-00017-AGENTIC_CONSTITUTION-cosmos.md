...
TERM PREAMBLE:
    sutra: "We, the Sovereign (hereafter "the Principal"), in order to form a more perfect intelligence appar..."
    gloss:
        We, the Sovereign (hereafter "the Principal"), in order to form a more perfect intelligence apparatus, establish antifragile governance, insure cognitive tractability, provide for common-sensemaking, promote general well-being, and secure the blessings of autonomous execution for ourselves, do ordai...
end
...
TERM Section2PreservationofBoundaries:
    ...
    gloss:
        This structure is non-negotiable, preserving the systematic compartmentalization and clear attentional boundaries required by the Principal's cognitive-architectural preferences. Human interests and desires are often plural and eclectic; they shall be respected by the specialized teleology of each S...
end
...
TERM Section2TheDivisionofLabor:
    sutra: "| Level | AI Responsibility | Principal Responsibility | |-------|-------------------|-----------..."
    gloss:
...
TERM Section4EconomicViability:
    sutra: "The apparatus is compute-leveraged, enabled by the Principal's existing flat-rate consumer subscr..."
    gloss:
...
TERM CROSSREFERENCES:
    sutra: "- CANON-31140: IIC Constellation (operational implementation) - CANON-31141: Five Account Archite..."
    gloss:
        - CANON-31140: IIC Constellation (operational implementation)
- CANON-31141: Five Account Architecture (detailed specifications)
- CANON-31100: Acumen (sensing chain charter)
- CANON-32100: Coherence (synthesis chain charter)
- CANON-00006: Operations (procedural layer)
