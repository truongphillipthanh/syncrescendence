...
TERM CTheUnifiedInterface:
    sutra: "Principal Command (any of these invoke the protocol): - "Handle context transition" - "Close this..."
    gloss:
...
TERM CPrincipalOverride:
    sutra: "The AI proposes; the principal disposes"
    gloss:
...
TERM Verification:
    sutra: "- [ ] CANON-25200 created - [ ] coordination.yaml updated - [ ] Each platform configured ```"
    gloss:
        - [ ] CANON-25200 created
