...
4. **Canonization Candidates** — Documents in agents/, outbox/, or other staging areas that are mature enough for canon/ or engine/
...
```
orchestration/  — Coordination infrastructure (state/, scripts/, archive/)
canon/          — Constitutional documents (stable, high-value) + sn/
engine/         — Functions, prompts, avatars, model profiles, queue items
sources/        — Source material (raw/, processed/, research/)
...
|------|------------------|---------------------|-----------|
| [name] | agents/ | canon/inbox/CANON-[name] | [why ready] |
...
2. **Be specific** — File paths, not descriptions. "the teleology document" → `canon/CANON-constellation-teleology.md`
