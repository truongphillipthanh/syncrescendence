...
### 7. Cross-Reference: CLAUDE.md + COCKPIT.md Neural Bridge Section
```bash
...
```bash
ssh -o ConnectTimeout=5 macbook-air 'ls -d ~/Desktop/syncrescendence/-INBOX/ajna/00-INBOX0/ 2>/dev/null && echo EXISTS || echo MISSING'
```
Must return EXISTS.
