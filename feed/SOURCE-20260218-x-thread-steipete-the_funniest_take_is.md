...
- **tmuswatch** - Lightweight TUI to watch tmux sessions
- **agent-rules** - Shared rules/knowledge for coding with agents
- **Markdumi** - Wrap, colors, links—no baggage.
- **llm-codes** - Transform developer documentation for AI agents
- **Stats Store** - Fast, privacy-first analytics for Sparkle (data-store)
- **Demark** - Mark My Words, HTML to Markdown!
- **eightctl** - Control your sleep, from the terminal
- **Imsg** - Send, read, stream iMessage & SMS
- **homebrew-tap** - Brew tap for shaping my CLI tools fast