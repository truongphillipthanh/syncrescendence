# CLUSTERING TASK — Cartographer (Gemini Pro 3.1)
...
## Your Assignment
You are taking files **00001 through 04000**. For each file:
...
Example:
```
00001.md	claude-code	content-creation	Thread about Claude Code customization features
00050.md	ai-safety	openclaw	CLAWDBOT security hardening guide
```
...
- Write output to `/Users/system/syncrescendence/corpus/CLUSTER-MAP-CARTOGRAPHER.tsv`
