...
1. Create dropbox: `mkdir -p agents/blitzkrieg_drop/inbox/`
...
### Missing Context
```
ERROR: agents/blitzkrieg_drop/inbox/context.md not found.
Create this file with session context before running blitzkrieg_finalize.
```

### Missing Directives
```
ERROR: No directive-*.md files found in agents/blitzkrieg_drop/inbox/.
...
| Protocol doc | `engine/BLITZKRIEG_PROTOCOL.md` |
