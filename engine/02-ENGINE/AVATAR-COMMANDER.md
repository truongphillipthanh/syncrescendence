...
| Directory | Purpose |
|-----------|---------|
| `orchestration/` | Strategic coordination, scripts, state |
| `canon/` | Verified canonical knowledge (PROTECTED) |
| `engine/` | Functions, prompts, avatars, configs |
...
- Do NOT modify `canon/` without explicit Sovereign approval
- Do NOT delete `orchestration/state/` files without approval
