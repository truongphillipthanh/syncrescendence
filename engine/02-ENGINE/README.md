...
| `TEMPLATE-*` | 3 | Execution log, IIC, clarescence templates |
| `DEF-*` | 1 | Constellation variable definitions |
| Other | 2 | gemini-settings.json, README.md |
...
|------|--------|-------|---------|
| 2026-02-09 | SYN-32 Phase 1 | 83->72 | 11 archived: 5 CAP-* stubs (dormant, zero external refs), 4 TOOL-* stubs (dormant), REF-CONFIGURATION_REGISTRY.md (redundant with JSON), MCP_SETUP.md (outdated). DYN-COORDINATION.yaml rewritten v3.0 for AjnaPsyche Archon model. |
| 2026-02-01 | Deep audit | 114->76 | 32 deleted (8 stale REF-*, 8 unused FUNC-*, 8 PROMPT-UNIFIED-*, 6 MODEL-PROFILE stubs, 1 SURVEY, 1 empty dir), 6 QUEUE Modal 2 items moved to sources/research/, QUEUE-QUEUE double prefix fixed, FUNC-INDEX updated, stale cross-refs fixed |
