...
3. **canon/README.md** — Constitutional documents

### Reading Strategy
- Skim for gist, don't exhaust context on full reads
- Focus on what's actually getting built (orchestration/directives)
- Read the constitutional stuff (canon) to understand stakes
...
ls orchestration/directives/DIRECTIVE-04*.md

# See constitutional docs
ls canon/CANON-000*.md
```
