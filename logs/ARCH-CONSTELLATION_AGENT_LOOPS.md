...
/SENSE := parallel({
  ...
  canon_drift:   diff canon/ since last checkpoint (3 sec)
...
- `orchestration/state/REF-NEO_BLITZKRIEG_BUILDOUT.md` — Blitzkrieg architecture
- `orchestration/scripts/cockpit.sh` — Tmux creation script
- `orchestration/scripts/watch_dispatch.sh` — Filesystem kanban watcher
- `engine/REF-FLEET_COMMANDERS_HANDBOOK.md` — Operator handbook
