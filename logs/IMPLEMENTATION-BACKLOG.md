...
- IMPL-A-0017 — System 2 ‘save-to-queue’ capture protocol + processor to sources/processed/
...
- IMPL-D-0086 — expand lint coverage beyond engine (or add scoped linters)
...
- IMPL-P-0009 — Build `archive_research.sh`: Move processed files to sources/research/batch-YYYY-MM-DD/, update manifest, commit
