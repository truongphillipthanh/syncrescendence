...
All scripts in `orchestration/scripts/`. All hooks configured in `.claude/settings.json`.
...
| Reference | Path |
|-----------|------|
| Original Blitzkrieg | `orchestration/state/REF-BLITZKRIEG_PROTOCOL_VNEXT.md` |
| CLI Enlistment | `engine/REF-CLI_ENLISTMENT.md` |
| Twin Coordination | `orchestration/state/DYN-TWIN_COORDINATION_PROTOCOL.md` |
| Intention Compass | `orchestration/state/ARCH-INTENTION_COMPASS.md` |
| DEF Variables | `engine/DEF-CONSTELLATION_VARIABLES.md` |
| Account Structure | `COCKPIT.md` (Three Accounts section) |
| Constellation Teleology | `canon/CANON-25200` (includes merged teleology) |
