...
- id: IMPL-A-0001
  source_path: engine/REF-ROSETTA_STONE.md
...
- id: IMPL-A-0003
  ...
  status: done
  linear_id: SYN-7
  notes: "Completed 2026-02-09: Directory 05-Ring→praxis done (prior session). σ₇-First terminology in ARCH-TOOLCHAIN_CLARESCENCE.md. Sigma/tau governance note ratified in REF-ROSETTA_STONE.md entry #5. CANON 'Transcendence Ring' refs preserved as ontological content. 2026-02-10: Residual sweep — preface-to-research.md 3 Ring→σ fixes (Ring 7→σ₇, Ring 0→σ₀)."
...
- id: IMPL-A-0008
  source_path: orchestration/state/ARCH-TOOLCHAIN_CLARESCENCE.md
...
- id: IMPL-A-0012
  source_path: orchestration/state/REF-NEO_BLITZKRIEG_BUILDOUT.md
...
- id: IMPL-A-0016
  source_path: orchestration/state/REF-FOUR_SYSTEMS.md
...
- id: IMPL-A-0017
  ...
  deliverable: A capture protocol for watch-later/bookmark inputs (YouTube Watch Later, browser share sheet, etc.) with a deterministic queue file format and a processor that deposits cleaned sources into sources/processed/.
...
- id: IMPL-A-0021
  ...
  dependencies: Dispatch kanban protocol + directory conventions (agents/<agent>/inbox/sources).
  owner_lane: Commander
  venue: repo
  status: new
  linear_id: SYN-14
...
- id: IMPL-B-0001
  source_path: orchestration/state/DYN-TWIN_COORDINATION_PROTOCOL.md
...
- id: IMPL-B-0009
  source_path: orchestration/state/DYN-DISPATCH_KANBAN_PROTOCOL.md
...
- id: IMPL-C-0001
  source_path: canon/CANON-30420-MULTI_AGENT_ORCHESTRATION-asteroid-INTELLIGENCE.md
...
- id: IMPL-C-0006
  source_path: canon/CANON-30430-MEMORY_SYSTEMS-asteroid-INTELLIGENCE.md
...
- id: IMPL-C-0012
  source_path: canon/CANON-30300-TECH_STACK-comet-INTELLIGENCE.md
...
- id: IMPL-D-0073
  ...
  deliverable: Guard `sources/DYN-SOURCES.csv` reads with existence check.
  dependencies: None.
  owner_lane: Commander
  venue: repo
  status: done
...
- id: IMPL-D-0083
  source_path: orchestration/scripts/verify_all.sh
...
- id: IMPL-D-0085
  source_path: orchestration/scripts/ops_lint.sh
...
- id: IMPL-D-0086
  source_path: orchestration/scripts/ops_lint.sh
  source_lines: "Scope limited to flat engine/"
  intent: Prevent frontmatter drift in other critical zones.
  deliverable: Extend lint coverage to additional directories (orchestration/state/*, canon/*) or add separate linters with explicit scopes.
...
- id: IMPL-D-0087
  source_path: orchestration/scripts/triage_outgoing.sh
...
- id: IMPL-D-0089
  source_path: orchestration/scripts/regenerate_canon.py
...
- id: IMPL-D-0091
  source_path: orchestration/scripts/intent_compass.sh
  ...
  dependencies: Decide where rules live (orchestration/state/ or engine/).
  owner_lane: Psyche
  venue: repo
  status: new
  linear_id: SYN-41
...
- id: IMPL-D-0095
  source_path: orchestration/scripts/dispatch.sh
...
- id: IMPL-D-0101
  source_path: orchestration/scripts/watch_canon.sh
...
- id: IMPL-D-0034
  source_path: orchestration/scripts/rearm_watchers.sh
  ...
  dependencies: orchestration/scripts/launchd-mini/*, orchestration/scripts/launchd-psyche/*
  owner_lane: Psyche
  venue: repo
  status: done
  linear_id: SYN-34
...
- id: IMPL-D-0035
  source_path: orchestration/scripts/launchd-mini/com.syncrescendence.watch-*.plist
...
- id: IMPL-D-0036
  source_path: orchestration/scripts/watch_dispatch.sh
...
- id: IMPL-D-0040
  source_path: orchestration/scripts/launchd-*/com.syncrescendence.watch-*.plist
...
- id: IMPL-D-0042
  source_path: orchestration/state/impl/tooling/OUTFITMENT-SYNC.md
...
- id: IMPL-D-0043
  source_path: orchestration/scripts/sync_openclaw_skills.sh
...
- id: IMPL-D-0063
  ...
  dependencies: Decide allowed kind set for engine (PROMPT/REF/etc.).
  owner_lane: Psyche
  venue: repo
  status: new
  linear_id: SYN-20
...
- id: IMPL-D-0070
  source_path: orchestration/scripts/verify_all.sh + Makefile
...
- id: IMPL-E-0001
  source_path: orchestration/TERMINAL-STACK-CONFIG.md
...
- id: IMPL-E-0002
  source_path: orchestration/scripts/cockpit.sh
...
- id: IMPL-E-0006
  source_path: orchestration/state/impl/clarescence/CLARESCENCE-2026-02-08-cockpit-lifestyle-layer.md
...
- id: IMPL-E-0007
  source_path: orchestration/FLEET-COMMANDERS-HANDBOOK.md
  source_lines: "v1.1"
...
- id: IMPL-F-0009
  source_path: orchestration/state/ARCH-INTENTION_COMPASS.md
  ...
  dependencies: Identify where temporal intel lives (ARCH-*, sources syntheses, etc.).
  owner_lane: Psyche
  venue: repo
  status: new
  linear_id: SYN-46
...
- id: IMPL-G-0004
  ...
  deliverable: Design a ‘Memory Crystal’ spec adapted to Syncrescendence: librarian sub-agent or script that writes compressed session summary to a durable target (e.g., praxis/MEMORY-* or orchestration/state/DYN-*) with citations and freshness markers.
...
- id: IMPL-H-0001
  source_path: orchestration/scripts/ajna_pedigree.sh
...
- id: IMPL-H-0002
  source_path: orchestration/scripts/append_ledger.sh
...
- id: IMPL-H-0003
  source_path: orchestration/scripts/audit_applications.sh
  source_lines: "1–350 (full script)"
  intent: Operationalize application audit so golden state is maintained automatically.
  deliverable: (a) Schedule audit_applications.sh via cron/launchd monthly, (b) store generated Brewfile and report in repo (orchestration/state/DYN-BREWFILE.md and DYN-APP_AUDIT.md), (c) drift detection: compare current Brewfile against stored and alert on divergence.
...
- id: IMPL-H-0004
  ...
  deliverable: (a) Implement sync-drive target with rclone or alternative (or DecisionAtom to remove), (b) verify watchdog.sh path ($HOME/.syncrescendence/scripts/ vs orchestration/scripts/), (c) add missing target help-text for model-db, model-query, search.
...
- id: IMPL-I-0001
  source_path: canon/CANON-31150-PLATFORM_CAPABILITY_CATALOG.md
  ...
  dependencies: Python env with regenerate_canon.py; write access to canon/.
  owner_lane: Ajna
  venue: repo
  status: done
  linear_id: SYN-29
...
- id: IMPL-I-0003
  source_path: orchestration/scripts/corpus_health_check.py
...
- id: IMPL-J-0001
  source_path: canon/CANON-31141-FIVE_ACCOUNT
...
- id: IMPL-J-0006
  source_path: canon/CANON-30420-MULTI_AGENT_ORCHESTRATION
...
- id: IMPL-J-0008
  source_path: canon/CANON-30430-MEMORY_SYSTEMS
...
- id: IMPL-J-0011
  source_path: canon/CANON-31130-SEVEN_LAYER
...
- id: IMPL-K-0001
  source_path: engine/REF-AIRTABLE_INTEGRATION.md
...
- id: IMPL-K-0003
  source_path: engine/REF-JIRA_INTEGRATION.md
...
- id: IMPL-K-0004
  source_path: engine/REF-TODOIST_INTEGRATION.md
...
- id: IMPL-K-0006
  source_path: engine/REF-WEB_APP_MEMORY_AUDIT.md
...
- id: IMPL-K-0008
  source_path: orchestration/state/impl/sensing/TEMPLATE-frontier-scan.md
...
- id: IMPL-K-0009
  source_path: orchestration/state/impl/sensing/TEMPLATE-corpus-staleness.md
  source_lines: "full template"
...
- id: IMPL-K-0010
  source_path: orchestration/state/impl/sensing/TEMPLATE-linear-impl-sync.md
  source_lines: "full template"
...
- id: IMPL-K-0011
  source_path: orchestration/state/impl/sensing/TEMPLATE-ecosystem-health.md
  source_lines: "full template"
...
- id: IMPL-M-0010
  source_path: orchestration/scripts/launchd/*sensing*.plist
...
- id: IMPL-N-0001
  source_path: engine/REF-JIRA_SYNC_MAP.md
...
- id: IMPL-N-0010
  source_path: orchestration/scripts/launchd/*.plist
  source_lines: "All 12 plist files"
  intent: Complete M-0010 by committing and activating all launchd agents.
  deliverable: (a) Add plists to git (orchestration/scripts/launchd/), (b) launchctl load for sensing jobs, (c) verify with launchctl list | grep syncrescendence, (d) check /tmp logs after first runs.
