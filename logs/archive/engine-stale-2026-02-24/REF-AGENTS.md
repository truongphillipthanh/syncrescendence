...
- `orchestration/` — Strategic coordination (directives, logs, state)
- `canon/` — Verified canonical knowledge (PROTECTED)
- `engine/` — Functions, prompts, model profiles, queue items
- `sources/` — Source documents (raw/, processed/)
...
3. **PROTECTED ZONES**: orchestration/state/ and canon/ require explicit approval for deletions.
