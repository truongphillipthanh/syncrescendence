...
- `/Users/home/Desktop/syncrescendence/orchestration/scripts/watch_dispatch.sh ajna`
...
- `orchestration/scripts/triage_inbox.sh` — summarizes PENDING/CLAIMED/COMPLETE/FAILED and detects stale CLAIMED by `Claimed-At`.
- `orchestration/scripts/watch_dispatch.sh` — implements claim-locking and lifecycle transitions.
