...
committed to `engine/REF-ROSETTA_STONE.md`. The annealment v2 verification (ANNEAL-V2-PATCHES.md)
...
| Annealment v2 | `orchestration/state/ARCH-ONTOLOGY_ANNEALMENT_v2.md` | Primary source (787 lines) — delegate |
| Patch file | `impl/.scratch/ANNEAL-V2-PATCHES.md` | Tier 3 object types (PATCH-001), references to ~25 terms |
| Rosetta Stone | `engine/REF-ROSETTA_STONE.md` | Target file (v2.7.0, 1,012 lines) — delegate reads |
