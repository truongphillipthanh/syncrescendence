...
```
Read orchestration/state/impl/HANDOFF-20260222-unified-commander.md — execute the action plan in order. All decisions are pre-made by Oracle + Commander consensus. No planning needed, pure execution.
```
...
6. State relocations (REF files → engine, ARCH files compaction)
