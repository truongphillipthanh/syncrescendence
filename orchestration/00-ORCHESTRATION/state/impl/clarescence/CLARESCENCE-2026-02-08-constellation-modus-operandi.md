...
|-------|-------------|---------------------|
| Commander | orchestration/state/, canon/, -SOVEREIGN/ | IMPLEMENTATION-MAP.md, COCKPIT.md |
| Adjudicator | Test files, formatting passes, -INBOX/adjudicator/ | canon/ (read), engine/ (read) |
| Cartographer | praxis/, survey reports, -INBOX/cartographer/ | canon/ (read), engine/ (read) |
