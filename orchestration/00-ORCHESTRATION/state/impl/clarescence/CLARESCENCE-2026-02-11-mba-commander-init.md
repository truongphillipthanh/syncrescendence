...
1. `orchestration/scripts/mba-cockpit.sh` — 2-pane tmux cockpit
2. `orchestration/scripts/mba-commander-init.sh` — one-shot MCP + config setup
...
git pull
bash orchestration/scripts/mba-commander-init.sh
source ~/.zshrc
mba-cockpit --launch
```
