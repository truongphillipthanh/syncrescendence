...
AUTO_INGEST="${REPO_ROOT}/orchestration/scripts/auto_ingest_loop.sh"
ORCHESTRATOR="${REPO_ROOT}/orchestration/scripts/proactive_orchestrator.sh"
WATCHDOG="${REPO_ROOT}/orchestration/scripts/constellation_watchdog.sh"
SUPERVISOR="${REPO_ROOT}/orchestration/scripts/auto_ingest_supervisor.sh"
DISPATCH="${REPO_ROOT}/orchestration/scripts/dispatch.sh"
