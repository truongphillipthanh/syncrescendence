...
- `sources/research/MECH-subagent_delegation.md` — Full mechanics (built-in types, invocation methods, coordinator pattern)
- `engine/REF-ROSETTA_STONE.md` — Gap Analysis G8
