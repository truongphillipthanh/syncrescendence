...
**Pipeline Phase**: 3-5 (Phase 0-2 complete — raw sources in `sources/research/gemini/`)
...
**Avatar Config**: `engine/AVATAR-GEMINI-CLI.md` v4.0.0 (exists)
**Initialization File**: `engine/MCP_SETUP.md` references GEMINI.md — **NOT in root**
...
### Known Friction
- GEMINI.md is in `engine/`, not root — Cartographer may not find it on init
...
**Pipeline Phase**: 3-5 (Phase 0-2 complete — raw sources in `sources/research/codex/`)
**Raw Source Lines**: 3,470 across 6 files + 1 article
**Avatar Config**: `engine/AVATAR-CODEX.md` v2.0.0 (exists)
...
| Cartographer (Gemini CLI) | GEMINI.md (needs root stub) | COCKPIT.md | canon/ subset |
