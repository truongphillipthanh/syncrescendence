...
Normalized 79 files from Pool B subdirectories into the flat `04-SOURCES/` root using the canonical naming convention:
...
|--------|------------|-------|
| research/ajna9-fodder/ | 05-SIGMA/research-streams/ | 25 files |
...
- All SOURCE-*.md files are in 04-SOURCES/ root (flat)
