...
**Executed**: 2026-02-21
**Manifest**: `04-SOURCES/_meta/DEDUP_MANIFEST.csv` (720 rows: 334 keep, 385 delete, 1 header)
...
All from `04-SOURCES/research-notebooks/`:
...
These 32 Pool C (NotebookLM) files were NOT deleted because their designated keeper in `04-SOURCES/research/` does not exist at the expected flat path. The keeper paths reference `04-SOURCES/research/<filename>.md` but that directory contains subdirectories, not flat files. These need resolution in a subsequent pass.

---

## Files Already Missing (12)

All 12 were in `04-SOURCES/research-notebooks/11-openclaw-deep-research-constellation/` — this directory was already cleaned up prior to this operation. The 10 PROMPT/RESPONSE openclaw files and 2 others were already gone.
