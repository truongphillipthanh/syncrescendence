...
- Update `praxis/EXEMPLA-TEMPLATE-DIRECTIVE.md` to include envelope
...
1. Update `praxis/EXEMPLA-TEMPLATE-DIRECTIVE.md` with envelope header
2. Create `praxis/EXEMPLA-TEMPLATE-RELAY_PACKET.md` for Phase 3
