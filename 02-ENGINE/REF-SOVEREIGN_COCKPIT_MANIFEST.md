...
> **Supersedes**: `00-ORCHESTRATION/TERMINAL-STACK-CONFIG.md` (deleted in commit `8b8f965`). This manifest is its comprehensive, verbatim successor.
...
startup_command = "bash 00-ORCHESTRATION/scripts/cockpit.sh"
...
### Cockpit Script
**File**: `~/Desktop/syncrescendence/00-ORCHESTRATION/scripts/cockpit.sh` (355 lines)
...
;; ── org-journal ─────────────────────────────────────────────────────────
(after! org-journal
  (setq org-journal-dir "~/Desktop/syncrescendence/05-SIGMA/journal/"
...
(defun syncrescendence-read-only-state ()
  ...
  (when (and buffer-file-name
             (string-match-p "00-ORCHESTRATION/state/" buffer-file-name))
    (read-only-mode 1)))
...
(map! :leader
      (:prefix ("d" . "dashboard")
       ...
       :desc "Terminal Stack" "t" #'(lambda () (interactive) (find-file "~/Desktop/syncrescendence/00-ORCHESTRATION/TERMINAL-STACK-CONFIG.md"))
       :desc "Implementation Map" "m" #'(lambda () (interactive) (find-file "~/Desktop/syncrescendence/00-ORCHESTRATION/state/IMPLEMENTATION-MAP.md"))
...
**GHOST REFERENCE**: Line `"t"` dashboard keybinding points to the DELETED `TERMINAL-STACK-CONFIG.md`. Should be updated to point to `02-ENGINE/REF-SOVEREIGN_COCKPIT_MANIFEST.md` once the manifest is written.
    ...
    "defaults": {
      ...
      "memorySearch": {
        ...
        "extraPaths": [
          ...
          "/Users/home/Desktop/syncrescendence/02-ENGINE/REF-ROSETTA_STONE.md",
          "/Users/home/Desktop/syncrescendence/02-ENGINE/REF-STACK_TELEOLOGY.md"
        ],
        "provider": "openai",
