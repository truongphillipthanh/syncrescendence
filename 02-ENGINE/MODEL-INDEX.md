...
|-------|-----|------------|---------|---------|-----------|----------|
| **DeepSeek-V4** | DeepSeek | Hybrid MoE | 1M+ | ~2026-02-17 (EXPECTED) | Engram memory, 1M+ context, hybrid reasoning/chat | IMMINENT RELEASE |
...
**Notes**:
- DeepSeek V4 targets Feb 17, 2026 release — unifying V3.x and R1 into single hybrid model.
