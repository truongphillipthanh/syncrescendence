...
└─ Delta Brief: "Interpreted user requirements → specifications in -INBOX/"
```
...
4. Include minimal spec: "Phase 2 task: Transform -INBOX/spec.md → Canvas document per template"
...
```json
{
  ...
  "delta": {
    "brief": "Interpreted user requirements → specifications in -INBOX/",
    "inputs": ["-INBOX/user-request.md"],
    "outputs": ["-INBOX/phase1-spec.md"],
    "decisions": [
...
WHAT'S READY:
• Specification document: -INBOX/phase1-spec.md
