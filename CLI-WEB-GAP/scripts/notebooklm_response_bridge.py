#!/usr/bin/env python3
"""Bridge a returned NotebookLM response artifact into the shared event/ontology pipeline."""
...
def main() -> int:
    ...
    if args.source_count is not None:
        payload["source_count"] = args.source_count
    validate_request(
        surface="exocortex",
    ...
    event_path = emit_event(
        ...
        surface="exocortex",
        artifact_class="repo_markdown_change",
        event_type="notebooklm_response_landed",
