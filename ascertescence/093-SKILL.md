...
Write the reviewtrospective to `orchestration/state/DYN-REVIEWTROSPECTIVE_LOG.md`:
...
- `orchestration/state/DYN-REVIEWTROSPECTIVE_LOG.md` — Review log (created by this skill)
- `orchestration/state/DYN-EXECUTION_STAGING.md` — Execution tracking (input)
- `.claude/skills/execute.md` — Execution (upstream trigger)
- `.claude/skills/method_kaizen.md` — Improvement crystallization (downstream)
- `orchestration/scripts/compact_wisdom.sh` — Log compaction
