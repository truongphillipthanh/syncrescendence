...
|----------|------|-------------|
| CANON-30430 Memory Systems | `canon/CANON-30430-MEMORY_SYSTEMS-asteroid-INTELLIGENCE.md` | Theoretical foundation (taxonomy, architectures, vector DBs) |
| Memory Architecture Matrix | `engine/REF-MEMORY_ARCHITECTURE_MATRIX.md` | IIC platform-specific memory layers (predecessor to this audit) |
| Constellation Agent Loops | `orchestration/state/ARCH-CONSTELLATION_AGENT_LOOPS.md` | Agent loop memory dependencies |
| MCP Configuration | `~/.claude/projects/-Users-home/memory/mcp-configuration.md` | MCP server status for memory-related tools |
| Automation Master Plan | `orchestration/state/ARCH-AUTOMATION_MASTER_PLAN.md` | Backup automation context |
| Stack Teleology | `engine/REF-STACK_TELEOLOGY.md` | Technology stack decisions |
| SaaS Integration | `engine/REF-SAAS_INTEGRATION_ARCHITECTURE.md` | Platform integration architecture |
