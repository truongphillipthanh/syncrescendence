...
**Monetization reality**: ClawHub itself has no commerce layer. Paywalled skills operate off-platform — private distributions, Patreon-gated repos, "DM me for key" models. First-class monetization is a gap in the current registry design.
